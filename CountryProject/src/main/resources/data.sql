...
INSERT INTO
    Countries
(country_name,description,date_founded,flag_past_url,map_url,history_text )
VALUES ('Ottoman Empire'
        ...
        ,'1299-02-02'
        ,'https://upload.wikimedia.org/wikipedia/commons/thumb/8/8e/Flag_of_the_Ottoman_Empire_%281844%E2%80%931922%29.svg/188px-Flag_of_the_Ottoman_Empire_%281844%E2%80%931922%29.svg.png'
        ,'turkey/turkiye.json'
        ,'
...
(DATE_FIRST_USED,DESCRIPTION,FLAG_URL,CREATOR)
VALUES
    ('1920-03-30','Two equal horizontal bands of white (top) and red with a blue isosceles triangle based on the hoist side.',
...
INSERT INTO
    Countries
(country_name,description,date_founded,flag_past_url,map_url,history_text,modern_flag_id )
VALUES ('Czech Republic'
       ...
       ,'1993-01-01'
       ,'https://www.tresbohemes.com/wp-content/uploads/2018/04/The-Origin-and-Evolution-of-the-Czech-Flag-Tres-Bohemes-1-.png'
       ,'czech-republic/czech-republic-regions.json'
...
INSERT INTO QUESTIONS (ANSWER,FAKE_ANSWER_ONE,FAKE_ANSWER_TWO,FAKE_ANSWER_THREE,QUESTION,COUNTRY_ID) VALUES ('Turkish','Greek','Iraqi','English','What language was spoken by the ruler of the Ottoman Empire ?',3);

INSERT INTO QUESTIONS (ANSWER,FAKE_ANSWER_ONE,FAKE_ANSWER_TWO,FAKE_ANSWER_THREE,QUESTION,COUNTRY_ID) VALUES ('Constantinople','Istanbul','Ankara','Athens','What is was the capital of the Ottoman Empire for most of it"s existence ?',3);

INSERT INTO QUESTIONS (ANSWER,FAKE_ANSWER_ONE,FAKE_ANSWER_TWO,FAKE_ANSWER_THREE,QUESTION,COUNTRY_ID) VALUES ('World War 1','Napoleaonic Wars','First Balkan War','World War 2','What war ended the Ottoman Empire ?',3);




INSERT INTO QUESTIONS (ANSWER,FAKE_ANSWER_ONE,FAKE_ANSWER_TWO,FAKE_ANSWER_THREE,QUESTION,COUNTRY_ID) VALUES ('Czech','French','polish','German','What language do they speak in Czechia',4);

INSERT INTO QUESTIONS (ANSWER,FAKE_ANSWER_ONE,FAKE_ANSWER_TWO,FAKE_ANSWER_THREE,QUESTION,COUNTRY_ID) VALUES ('Prague','Vienna','Budapest','Brest','What is the capital of Czechia',4);

INSERT INTO QUESTIONS (ANSWER,FAKE_ANSWER_ONE,FAKE_ANSWER_TWO,FAKE_ANSWER_THREE,QUESTION,COUNTRY_ID) VALUES ('the Czech lion','the Czech eagle','the Czech wolf','the Czech bear','What is the national animal of Czechia ?',4);
